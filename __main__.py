...
for i in range(0, number_of_records):
    t = transactions[i % num_threads]
    t.add_query(query.insert, grades_table, *[906659671 + i, 93, 0, 0, 0])
...
# print("Aggregate 100 of 100 record batch took:\t", agg_time_1 - agg_time_0)
...
# for i in range(0, 2000):
#     t = transactions[i % num_threads]
#     t.add_query(query.delete, grades_table, 906659671 + i)
