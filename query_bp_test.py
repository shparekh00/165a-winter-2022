...
print("Updating 1000 records took:  \t\t\t", update_time_1 - update_time_0)
...
print("Aggregate 1000 of 1000 record batch took:\t", agg_time_1 - agg_time_0)
...
print("Deleting 1000 records took:  \t\t\t", delete_time_1 - delete_time_0)